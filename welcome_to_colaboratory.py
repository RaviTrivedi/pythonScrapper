...
# table = soup.find('div', attrs = {'class':'row flexi-row'})
# print(table)
# tableRow = soup.find_all('div', attrs = {'class':'flexi-div'})
# print(tableRow)
# Equipment = {}
...
def driverSectionScrapper():
    ...
    for label in driverRowData:
        ...
        # print(label.find('p', class_="info-value").get_text().replace("\n",""))
    print("driver",driver)
...
def eventSectionScrapper():
    ...
    for label in rowData:
        ...
        # print(label.find('p', class_="info-value").get_text().replace("\n",""))
        # print(label.find('label', class_="info-label").get_text().replace("\n",""))
        # print("---------------")
    print("COMPLETE",event)
# eventSectionScrapper()


# Complete Data Scrapped Billing Section
...
def serviceLineItemsFirstSection():
    ...
    # print(tableFour[0].find('div', attrs = {'class': 'panel-body'}).find('div', attrs = {'class': 'col-md-12'}))
    ...
    for idx,label in enumerate(firstRow):
        ...
        if idx==3:
            ...
            # print(secondRow[idx].get_text().replace("\n",""))

    print(service_line_items_one)
...
# tableFour = soup.find('div', attrs = {'class':'show_service_line_items'})
tableFour = soup.find('div', attrs = {'id':'service_line_items'}).find_all('div', attrs = {'class':'panel'})
# print(tableFour[0].find('div', attrs = {'class': 'panel-body'}).find_all('div', attrs = {'class': 'col-md-12'})[1])
...
for idx,label in enumerate(rowData):
    ...
    # print(valueTableTitleWheelOne)
    # print(valueTableDataWheelOne)
...
# for singleRow in tableRow:
#     # print(singleRow)
#     # print("-----------------")
#     print("VALUE")
#     for labelValue in singleRow.find_all("p", class_="info-value"):
#         print(labelValue.get_text().replace("\n",""))


# for text in table.find_all("label", class_="info-label"):
    # print(text.get_text().replace("\n","")) 
    # for value in table.find_all("p", class_="info-value"):
        # print(value.get_text().replace("\n",""))
        # Equipment[text.get_text().replace("\n","")] = value.get_text().replace("\n","")
        
# print(Equipment)
    # finalOutput['author'] = item.select_one('.author').get_text()
# print(table.find_all("label", class_="info-label")) 
# print(table.find_all("p", class_="info-value"))